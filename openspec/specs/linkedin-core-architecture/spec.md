# linkedin-core-architecture Specification

## Purpose
Define the structural boundaries and behavior-preserving rules for the LinkedIn
core refactor centered on the `src/` package.
