...
- Wellfound ingestion support through the shared `JobSourceAdapter` flow (fixture-backed and best-effort live scraping), including canonical normalization and CLI wiring via `ingest-wellfound`.
